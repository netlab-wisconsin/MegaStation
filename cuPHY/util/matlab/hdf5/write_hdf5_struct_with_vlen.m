...
h5File  = H5F.create('struct_with_vlen_example.h5', 'H5F_ACC_TRUNC', 'H5P_DEFAULT', 'H5P_DEFAULT');
...
A = struct('serial_no', {1153; 1184; 1027; 1313}, ...
           ...
           'vlen', {[int32(1), int32(2), int32(3)]; [int32(1), int32(2)]; [int32(1)]; [int32(1), int32(2), int32(3), int32(4)]});
