...
public:
    //------------------------------------------------------------------
    // node()
    node(yaml_document_t* d, yaml_node_t* n) : document_(d), node_(n) {}
    //------------------------------------------------------------------
    // type()
...
////////////////////////////////////////////////////////////////////////
// node::as<float>()
template <> inline float node::as<float>()
{
...
////////////////////////////////////////////////////////////////////////
// node::as<int>()
template <> inline int node::as<int>()
{
    if(YAML_SCALAR_NODE != type())
    {
        throw std::runtime_error(std::string("YAML invalid type: '") +
...
////////////////////////////////////////////////////////////////////////
// node::as<uint16_t>()
template <> inline uint16_t node::as<uint16_t>()
{
    if(YAML_SCALAR_NODE != type())
    {
        throw std::runtime_error(std::string("YAML invalid type: '") +
...
////////////////////////////////////////////////////////////////////////
// node::as<uint64_t>()
template <> inline uint64_t node::as<uint64_t>()
{
    if(YAML_SCALAR_NODE != type())
    {
        throw std::runtime_error(std::string("YAML invalid type: '") +
...
template <> inline unsigned int node::as<unsigned int>()
{
    if(YAML_SCALAR_NODE != type())
    {
        throw std::runtime_error(std::string("YAML invalid type: '") +
...
////////////////////////////////////////////////////////////////////////
// node::as<string>()
template <> inline std::string node::as<std::string>()
{
    if(YAML_SCALAR_NODE != type())
    {
        throw std::runtime_error(std::string("YAML invalid type: '") +
...
public:
    //------------------------------------------------------------------
    // file_parser()
    file_parser(const char* fname) : fp_(fopen(fname, "r"))
    {
        if(!fp_)
        {
