...
namespace cufftdx {
    namespace database {
        namespace detail {
            ...
            // Forward SM87 records to SM80 records
            template<unsigned int Size /* FFT size */, class Precision, fft_type Type, fft_direction Direction>
            struct block_fft_record<Size, Precision, Type, Direction, 870>:
                public block_fft_record<Size, Precision, Type, Direction, 800> {};

            // Forward SM89 records to SM70 records
            template<unsigned int Size /* FFT size */, class Precision, fft_type Type, fft_direction Direction>
            struct block_fft_record<Size, Precision, Type, Direction, 890>:
                public block_fft_record<Size, Precision, Type, Direction, 700> {};

            // Forward SM90 records to SM80 records
            template<unsigned int Size /* FFT size */, class Precision, fft_type Type, fft_direction Direction>
            struct block_fft_record<Size, Precision, Type, Direction, 900>:
                public block_fft_record<Size, Precision, Type, Direction, 800> {};
