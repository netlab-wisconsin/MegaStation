...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_cluster_index_half_BG2_Z352()
cuphyStatus_t decode_ldpc2_shared_cluster_index_half_BG2_Z352(const LDPC_config&        cfg,
                                                              ...
                                                              cudaStream_t              strm)
{
    ...
    // If Z = 352 and mb = 25:
    // SHMEM(Z = 352) = 352*[(10 + 25)*2 + 25*8] = 92.8 * 1024
    // With a maximum of 96 KB shared memory (Volta), all APP and cC2V data
    // can fit in shared memory up to 25 parity nodes
