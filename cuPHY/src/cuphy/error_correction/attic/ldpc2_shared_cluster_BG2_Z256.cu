...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_cluster_index_half_BG2_Z256()
cuphyStatus_t decode_ldpc2_shared_cluster_index_half_BG2_Z256(const LDPC_config&        cfg,
                                                              ...
                                                              cudaStream_t              strm)
{
    ...
    // If Z = 256 and mb = 36:
    // SHMEM(Z = 256) = 256*[(10 + 36)*2 + 36*8] = 95 * 1024
    // With a maximum of 96 KB shared memory (Volta), all APP and cC2V data
    // can fit in shared memory up to 36 parity nodes
