...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_cluster_index_half_BG2_Z320()
cuphyStatus_t decode_ldpc2_shared_cluster_index_half_BG2_Z320(const LDPC_config&        cfg,
                                                              ...
                                                              cudaStream_t              strm)
{
    ...
    // If Z = 320 and mb = 29:
    // SHMEM(Z = 320) = 320*[(10 + 29)*2 + 29*8] = 94.375 * 1024
