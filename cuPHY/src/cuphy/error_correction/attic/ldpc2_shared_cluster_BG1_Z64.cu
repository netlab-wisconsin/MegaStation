...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_cluster_index_half_BG1_Z64()
cuphyStatus_t decode_ldpc2_shared_cluster_index_half_BG1_Z64(const LDPC_config&        cfg,
                                                             ...
                                                             cudaStream_t              strm)
{
    ...
    case 43: s = launch_all_shared_cluster<__half, BG, Kb, Z, 43, cC2V_t, app_loc_address>(params, grdDim, blkDim, strm); break;
    case 44: s = launch_all_shared_cluster<__half, BG, Kb, Z, 44, cC2V_t, app_loc_address>(params, grdDim, blkDim, strm); break;            
    case 45: s = launch_all_shared_cluster<__half, BG, Kb, Z, 45, cC2V_t, app_loc_address>(params, grdDim, blkDim, strm); break;
    case 46: s = launch_all_shared_cluster<__half, BG, Kb, Z, 46, cC2V_t, app_loc_address>(params, grdDim, blkDim, strm); break;
    default: break;
    }
#endif // CUPHY_LDPC_INCLUDE_LEVEL >= 2
    return s;
}
