...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_half_BG1_Z320()
cuphyStatus_t decode_ldpc2_shared_half_BG1_Z320(ldpc::decoder&            dec,
                                                ...
                                                cudaStream_t              strm)
{
    ...
    // If Z = 320 and mb = 26:
    // SHMEM(Z = 320) = 320*[(22 + 26)*2 + 26*8] = 95 * 1024
    // With a maximum of 96 KB shared memory (Volta), all APP and cC2V data
    // can fit in shared memory up to 26 parity nodes
