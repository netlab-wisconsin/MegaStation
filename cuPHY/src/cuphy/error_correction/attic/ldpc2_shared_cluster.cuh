...
#if !defined(LDPC2_SHARED_CLUSTER_CUH_INCLUDED_)
#define LDPC2_SHARED_CLUSTER_CUH_INCLUDED_
...
template <typename                           T,
          ...
          int                                BLOCKS_PER_SM>
cuphyStatus_t launch_all_shared_cluster(ldpc::decoder&            dec,
...
#endif // !defined(LDPC2_SHARED_CLUSTER_CUH_INCLUDED_)
