...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_cluster_index_half_BG2_Z128()
cuphyStatus_t decode_ldpc2_shared_cluster_index_half_BG2_Z128(const LDPC_config&        cfg,
                                                              ...
                                                              cudaStream_t              strm)
{
    ...
    // If Z = 128 and mb = 42:
    // SHMEM(Z = 128) = 128*[(10 + 42)*2 + 42*8] = 55 * 1024
