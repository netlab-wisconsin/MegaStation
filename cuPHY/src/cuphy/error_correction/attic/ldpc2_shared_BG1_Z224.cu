...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_half_BG1_Z224()
cuphyStatus_t decode_ldpc2_shared_half_BG1_Z224(ldpc::decoder&            dec,
                                                ...
                                                cudaStream_t              strm)
{
    ...
    // If Z = 224 and mb = 39:
    // SHMEM(Z = 224) = 224*[(22 + 39)*2 + 39*8] = 94.9 * 1024
    // With a maximum of 96 KB shared memory (Volta), all APP and cC2V data
    // can fit in shared memory up to 39 parity nodes
