...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_half_BG1_Z192()
cuphyStatus_t decode_ldpc2_shared_half_BG1_Z192(ldpc::decoder&            dec,
                                                ...
                                                cudaStream_t              strm)
{
    ...
    // If Z = 192 and mb = 46:
    // SHMEM(Z = 192) = 192*[(22 + 46)*2 + 46*8] = 94.5 * 1024
    // With a maximum of 96 KB shared memory (Volta), all APP and cC2V data
    // can fit in shared memory all 46 parity nodes
