...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_cluster_index_half_BG2_Z384()
cuphyStatus_t decode_ldpc2_shared_cluster_index_half_BG2_Z384(const LDPC_config&        cfg,
                                                              ...
                                                              cudaStream_t              strm)
{
    ...
    // If Z = 384 and mb = 23:
    // SHMEM(Z = 384) = 384*[(10 + 23)*2 + 23*8] = 93.75 * 1024
