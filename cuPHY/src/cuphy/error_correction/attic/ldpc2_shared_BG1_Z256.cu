...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_half_BG1_Z256()
cuphyStatus_t decode_ldpc2_shared_half_BG1_Z256(ldpc::decoder&            dec,
                                                ...
                                                cudaStream_t              strm)
{
    ...
    // If Z = 256 and mb = 34:
    // SHMEM(Z = 256) = 256*[(22 + 34)*2 + 34*8] = 96 * 1024
    // With a maximum of 96 KB shared memory (Volta), all APP and cC2V data
    // can fit in shared memory up to 34 parity nodes
