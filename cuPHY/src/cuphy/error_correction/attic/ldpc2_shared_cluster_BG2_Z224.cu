...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_cluster_index_half_BG2_Z224()
cuphyStatus_t decode_ldpc2_shared_cluster_index_half_BG2_Z224(const LDPC_config&        cfg,
                                                              ...
                                                              cudaStream_t              strm)
{
    ...
    // If Z = 224 and mb = 41:
    // SHMEM(Z = 224) = 224*[(10 + 41)*2 + 41*8] = 94.1 * 1024
    // With a maximum of 96 KB shared memory (Volta), all APP and cC2V data
    // can fit in shared memory up to 41 parity nodes
