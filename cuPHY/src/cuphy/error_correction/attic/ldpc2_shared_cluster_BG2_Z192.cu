...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_cluster_index_half_BG2_Z192()
cuphyStatus_t decode_ldpc2_shared_cluster_index_half_BG2_Z192(const LDPC_config&        cfg,
                                                              ...
                                                              cudaStream_t              strm)
{
    ...
    // If Z = 192 and mb = 42:
    // SHMEM(Z = 192) = 192*[(10 + 42)*2 + 46*8] = 82.5 * 1024
