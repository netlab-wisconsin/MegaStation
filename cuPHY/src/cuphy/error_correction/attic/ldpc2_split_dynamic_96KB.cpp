...
#include "ldpc2_split_dynamic.hpp"

namespace ldpc2
{

////////////////////////////////////////////////////////////////////////
// decode_ldpc2_split_dynamic_half_96KB()
cuphyStatus_t decode_ldpc2_split_dynamic_half_96KB(const LDPC_config&        cfg,
...
#endif
        case 352: s = decode_ldpc2_split_dynamic_half_96KB_BG1_Z352(cfg, params, grdDim, blkDim, strm); break;
        case 384: s = decode_ldpc2_split_dynamic_half_96KB_BG1_Z384(cfg, params, grdDim, blkDim, strm); break;
        default:                                                                                        break;
        }
    }
    else if(cfg.BG == 2)
