...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_cluster_index_half_BG2_Z288()
cuphyStatus_t decode_ldpc2_shared_cluster_index_half_BG2_Z288(const LDPC_config&        cfg,
                                                              ...
                                                              cudaStream_t              strm)
{
    ...
    // If Z = 288 and mb = 32:
    // SHMEM(Z = 288) = 288*[(10 + 32)*2 + 32*8] = 95.625 * 1024
    // With a maximum of 96 KB shared memory (Volta), all APP and cC2V data
    // can fit in shared memory up to 32 parity nodes
