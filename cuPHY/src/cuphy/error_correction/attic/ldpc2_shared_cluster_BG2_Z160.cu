...
////////////////////////////////////////////////////////////////////////
// decode_ldpc2_shared_cluster_index_half_BG2_Z160()
cuphyStatus_t decode_ldpc2_shared_cluster_index_half_BG2_Z160(const LDPC_config&        cfg,
                                                              ...
                                                              cudaStream_t              strm)
{
    ...
    // If Z = 160 and mb = 42:
    // SHMEM(Z = 160) = 160*[(10 + 42)*2 + 42*8] = 68.75 * 1024
