...
#if !defined(LDPC_MS_CTA_FLOODING_HPP_INCLUDED_)
#define LDPC_MS_CTA_FLOODING_HPP_INCLUDED_

// Min-sum, Single Cooperative Thread Array, Flooding LDPC Implementation
