...
#if !defined(LDPC2_REG_INDEX_FP_DESC_DYN_SM80_HPP_INCLUDED_)
#define LDPC2_REG_INDEX_FP_DESC_DYN_SM80_HPP_INCLUDED_
...
////////////////////////////////////////////////////////////////////////
// reg_index_fp_desc_dyn_sm80
class reg_index_fp_desc_dyn_sm80 : public ldpc::decode_algo
{
public:
    //------------------------------------------------------------------
    // Constructor
    reg_index_fp_desc_dyn_sm80(ldpc::decoder& desc);
    //------------------------------------------------------------------
    // decode()
...
private:
    ...
    // public:
    cuphy_i::cu_module sm80_dyn_desc_module_;
    CUfunction         sm80_dyn_desc_BG1_kernel_;
    CUfunction         sm80_dyn_desc_BG2_kernel_;
    CUfunction         sm80_dyn_desc_BG1_tb_kernel_;
    CUfunction         sm80_dyn_desc_BG2_tb_kernel_;

};
    
} // namespace ldpc2

#endif // !defined(LDPC2_REG_INDEX_FP_DESC_DYN_SM80_HPP_INCLUDED_)
