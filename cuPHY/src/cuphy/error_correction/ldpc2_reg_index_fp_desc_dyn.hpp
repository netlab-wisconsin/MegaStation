...
#if !defined(LDPC2_REG_INDEX_FP_DESC_DYN_HPP_INCLUDED_)
#define LDPC2_REG_INDEX_FP_DESC_DYN_HPP_INCLUDED_
...
////////////////////////////////////////////////////////////////////////
// reg_index_fp_desc_dyn
class reg_index_fp_desc_dyn : public ldpc::decode_algo
{
public:
    //------------------------------------------------------------------
    // Constructor
    reg_index_fp_desc_dyn(ldpc::decoder& desc);
    //------------------------------------------------------------------
    // decode()
...
#endif // !defined(LDPC2_REG_INDEX_FP_DESC_DYN_HPP_INCLUDED_)
