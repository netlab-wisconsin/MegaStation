...
extern const uint8_t  ldpc2_reg_index_fp_desc_dyn_sm80_internal[];
extern unsigned int   ldpc2_reg_index_fp_desc_dyn_sm80_internal_size;

namespace
{

const char* sm80_dyn_desc_BG1_kernel_name    = "ldpc2_BG1_reg_index_fp_desc_dyn_sm80";
const char* sm80_dyn_desc_BG2_kernel_name    = "ldpc2_BG2_reg_index_fp_desc_dyn_sm80";
const char* sm80_dyn_desc_BG1_tb_kernel_name = "ldpc2_BG1_reg_index_fp_desc_dyn_sm80_tb";
const char* sm80_dyn_desc_BG2_tb_kernel_name = "ldpc2_BG2_reg_index_fp_desc_dyn_sm80_tb";
...
////////////////////////////////////////////////////////////////////////
// reg_index_fp_desc_dyn_sm80::decode()
cuphyStatus_t reg_index_fp_desc_dyn_sm80::decode(ldpc::decoder&                     dec,
                                                 LDPC_output_t&                     tDst,
                                                 const_tensor_pair&                 tLLR,
                                                 const cuphyLDPCDecodeConfigDesc_t& config,
                                                 cudaStream_t                       strm)
{
    DEBUG_PRINTF("ldpc2::reg_index_fp_desc_dyn_sm80::decode()\n");
    //------------------------------------------------------------------
    ...
    if(llrType == CUPHY_R_16F)
    {
        ...
        case 1:
            {
                const int         BG     = 1;
                CUfunction        f      = sm80_dyn_desc_BG1_kernel_;
        ...
        case 2:
            {
                const int         BG     = 2;
                CUfunction        f      = sm80_dyn_desc_BG2_kernel_;
...
////////////////////////////////////////////////////////////////////////
// reg_index_fp_desc_dyn_sm80::decode_tb()
cuphyStatus_t reg_index_fp_desc_dyn_sm80::decode_tb(ldpc::decoder&               dec,
                                                    const cuphyLDPCDecodeDesc_t& decodeDesc,
                                                    cudaStream_t                 strm)
{
    DEBUG_PRINTF("ldpc2::reg_index_fp_desc_dyn_80::decode_tb()\n");
    //------------------------------------------------------------------
    ...
    if(decodeDesc.config.llr_type == CUPHY_R_16F)
    {
        ...
        case 1:
            {
                const int         BG     = 1;
                CUfunction        f      = sm80_dyn_desc_BG1_tb_kernel_;
        ...
        case 2:
            {
                const int         BG     = 2;
                CUfunction        f      = sm80_dyn_desc_BG2_tb_kernel_;
...
////////////////////////////////////////////////////////////////////////
// reg_index_fp_desc_dyn_sm80::get_workspace_size()
std::pair<bool, size_t> reg_index_fp_desc_dyn_sm80::get_workspace_size(const ldpc::decoder&               dec,
                                                                       const cuphyLDPCDecodeConfigDesc_t& config,
                                                                       int                                num_cw)
{
...
////////////////////////////////////////////////////////////////////////
// reg_index_fp_desc_dyn_sm80::reg_index_fp_desc_dyn_sm80()
reg_index_fp_desc_dyn_sm80::reg_index_fp_desc_dyn_sm80(ldpc::decoder& dec)
{
    ...
    {
        sm80_dyn_desc_module_.load(ldpc2_reg_index_fp_desc_dyn_sm80_internal);
        sm80_dyn_desc_BG1_kernel_    = sm80_dyn_desc_module_.get_function(sm80_dyn_desc_BG1_kernel_name/*,    std::nothrow_t()*/);
        sm80_dyn_desc_BG2_kernel_    = sm80_dyn_desc_module_.get_function(sm80_dyn_desc_BG2_kernel_name/*,    std::nothrow_t()*/);
        sm80_dyn_desc_BG1_tb_kernel_ = sm80_dyn_desc_module_.get_function(sm80_dyn_desc_BG1_tb_kernel_name/*, std::nothrow_t()*/);
        sm80_dyn_desc_BG2_tb_kernel_ = sm80_dyn_desc_module_.get_function(sm80_dyn_desc_BG2_tb_kernel_name/*, std::nothrow_t()*/);
        //printf("sm80_dyn_desc_BG1_kernel_    = %p\n", sm80_dyn_desc_BG1_kernel_);
        //printf("sm80_dyn_desc_BG2_kernel_    = %p\n", sm80_dyn_desc_BG2_kernel_);
        //printf("sm80_dyn_desc_BG1_tb_kernel_ = %p\n", sm80_dyn_desc_BG1_tb_kernel_);
        //printf("sm80_dyn_desc_BG2_tb_kernel_ = %p\n", sm80_dyn_desc_BG2_tb_kernel_);
        ...
        {
            func_attr_t(sm80_dyn_desc_BG1_kernel_,    MAX_BG1_SHMEM_SIZE),
            func_attr_t(sm80_dyn_desc_BG2_kernel_,    MAX_BG2_SHMEM_SIZE),
            func_attr_t(sm80_dyn_desc_BG1_tb_kernel_, MAX_BG1_SHMEM_SIZE),
            func_attr_t(sm80_dyn_desc_BG2_tb_kernel_, MAX_BG2_SHMEM_SIZE)
        };
...
////////////////////////////////////////////////////////////////////////
// reg_index_fp_desc_dyn_sm80::get_launch_config()
cuphyStatus_t reg_index_fp_desc_dyn_sm80::get_launch_config(const ldpc::decoder&           dec,
