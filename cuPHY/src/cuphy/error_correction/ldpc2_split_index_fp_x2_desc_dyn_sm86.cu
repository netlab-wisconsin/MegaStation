...
extern const uint8_t  ldpc2_split_index_fp_x2_desc_dyn_sm86_internal[];
extern unsigned int   ldpc2_split_index_fp_x2_desc_dyn_sm86_internal_size;
extern const uint8_t  ldpc2_split_index_fp_x2_desc_dyn_sm86_internal_sm90[];
extern unsigned int   ldpc2_split_index_fp_x2_desc_dyn_sm86_internal_sm90_size;

namespace
{

const char* sm86_BG1_kernel_name    = "ldpc2_BG1_split_index_fp_x2_desc_dyn_sm86";
const char* sm86_BG2_kernel_name    = "ldpc2_BG2_split_index_fp_x2_desc_dyn_sm86";
const char* sm86_BG1_tb_kernel_name = "ldpc2_BG1_split_index_fp_x2_desc_dyn_sm86_tb";
const char* sm86_BG2_tb_kernel_name = "ldpc2_BG2_split_index_fp_x2_desc_dyn_sm86_tb";
...
////////////////////////////////////////////////////////////////////////
// split_index_fp_x2_desc_dyn_sm86::split_index_fp_x2_desc_dyn_sm86()
split_index_fp_x2_desc_dyn_sm86::split_index_fp_x2_desc_dyn_sm86(ldpc::decoder& dec)
{
    //------------------------------------------------------------------
    ...
    //------------------------------------------------------------------
    // Load cubin binaries. The sm86 kernel exists for sm90 as well, so
    // we conditionally load it based on the compute capability of the
    // current device.
    const uint64_t CC_9_0 = (9ULL << 32);
    sm86_module_.load(dec.compute_cap() >= CC_9_0                         ?
                      ldpc2_split_index_fp_x2_desc_dyn_sm86_internal_sm90 :
                      ldpc2_split_index_fp_x2_desc_dyn_sm86_internal);
    sm86_BG1_kernel_    = sm86_module_.get_function(sm86_BG1_kernel_name/*,    std::nothrow_t()*/);
    sm86_BG2_kernel_    = sm86_module_.get_function(sm86_BG2_kernel_name/*,    std::nothrow_t()*/);
    sm86_BG1_tb_kernel_ = sm86_module_.get_function(sm86_BG1_tb_kernel_name/*, std::nothrow_t()*/);
    sm86_BG2_tb_kernel_ = sm86_module_.get_function(sm86_BG2_tb_kernel_name/*, std::nothrow_t()*/);
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
    ...
    {
        func_attr_t(sm86_BG1_kernel_,    std::min(MAX_BG1_SHMEM_SIZE, MAX_SHMEM)),
        func_attr_t(sm86_BG2_kernel_,    std::min(MAX_BG2_SHMEM_SIZE, MAX_SHMEM)),
        func_attr_t(sm86_BG1_tb_kernel_, std::min(MAX_BG1_SHMEM_SIZE, MAX_SHMEM)),
        func_attr_t(sm86_BG2_tb_kernel_, std::min(MAX_BG2_SHMEM_SIZE, MAX_SHMEM))
    };
...
std::pair<bool, size_t> split_index_fp_x2_desc_dyn_sm86::get_workspace_size(const ldpc::decoder&               dec,
...
////////////////////////////////////////////////////////////////////////
// split_index_fp_x2_desc_dyn_sm86::can_decode_config()
bool split_index_fp_x2_desc_dyn_sm86::can_decode_config(const ldpc::decoder&               dec,
...
////////////////////////////////////////////////////////////////////////
// split_index_fp_x2_desc_dyn_sm86::decode()
cuphyStatus_t split_index_fp_x2_desc_dyn_sm86::decode(ldpc::decoder&                     dec,
                                                      LDPC_output_t&                     tDst,
                                                      const_tensor_pair&                 tLLR,
                                                      const cuphyLDPCDecodeConfigDesc_t& config,
                                                      cudaStream_t                       strm)
{
    DEBUG_PRINTF("ldpc::decode_ldpc2_split_index_fp_x2_desc_dyn_sm86()\n");
    //------------------------------------------------------------------
...
////////////////////////////////////////////////////////////////////////
// split_index_fp_x2_desc_dyn_sm86::decode_tb()
cuphyStatus_t split_index_fp_x2_desc_dyn_sm86::decode_tb(ldpc::decoder&               dec,
                                                         const cuphyLDPCDecodeDesc_t& decodeDesc,
                                                        cudaStream_t                 strm)
{
    DEBUG_PRINTF("ldpc2::split_index_fp_x2_desc_dyn_sm86::decode_tb()\n");
    ...
    if(decodeDesc.config.llr_type == CUPHY_R_16F)
    {
        ...
        case 1:
            {
                const int         BG         = 1;
                CUfunction        f          = sm86_BG1_tb_kernel_;
        ...
        case 2:
            {
                const int         BG         = 2;
                CUfunction        f          = sm86_BG2_tb_kernel_;
...
////////////////////////////////////////////////////////////////////////
// split_index_fp_x2_desc_dyn_sm86::get_launch_config()
cuphyStatus_t split_index_fp_x2_desc_dyn_sm86::get_launch_config(const ldpc::decoder&           dec,
