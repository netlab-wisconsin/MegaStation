...
#if !defined(LDPC2_SPLIT_INDEX_FP_X2_DESC_DYN_SM90_HPP_INCLUDED_)
#define LDPC2_SPLIT_INDEX_FP_X2_DESC_DYN_SM90_HPP_INCLUDED_
...
////////////////////////////////////////////////////////////////////////
// split_index_fp_x2_desc_dyn_sm90
class split_index_fp_x2_desc_dyn_sm90 : public ldpc::decode_algo
{
public:
    //------------------------------------------------------------------
    // Constructor
    split_index_fp_x2_desc_dyn_sm90(ldpc::decoder& desc);
    //------------------------------------------------------------------
    // decode()
    ...
    // CUDA driver API module for SM90 .cubin binaries with internal-only
    // instructions.
    // TODO: Remove and use CUDA runtime API when instructions are made
    // public:
    cuphy_i::cu_module sm90_module_;
    CUfunction         sm90_BG1_kernel_;
    CUfunction         sm90_BG2_kernel_;
    CUfunction         sm90_BG1_tb_kernel_;
    CUfunction         sm90_BG2_tb_kernel_;
};
    
} // namespace ldpc2

#endif // !defined(LDPC2_SPLIT_INDEX_FP_X2_DESC_DYN_SM90_HPP_INCLUDED_)
