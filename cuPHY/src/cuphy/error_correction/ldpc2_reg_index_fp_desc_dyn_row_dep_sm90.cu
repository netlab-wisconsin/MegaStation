...
extern const uint8_t  ldpc2_reg_index_fp_desc_dyn_row_dep_sm90_internal[];
extern unsigned int   ldpc2_reg_index_fp_desc_dyn_row_dep_sm90_internal_size;

namespace
{

const char* sm90_dyn_desc_row_dep_BG1_kernel_name    = "ldpc2_BG1_reg_index_fp_desc_dyn_row_dep_sm90";
const char* sm90_dyn_desc_row_dep_BG2_kernel_name    = "ldpc2_BG2_reg_index_fp_desc_dyn_row_dep_sm90";
const char* sm90_dyn_desc_row_dep_BG1_tb_kernel_name = "ldpc2_BG1_reg_index_fp_desc_dyn_row_dep_sm90_tb";
const char* sm90_dyn_desc_row_dep_BG2_tb_kernel_name = "ldpc2_BG2_reg_index_fp_desc_dyn_row_dep_sm90_tb";
...
////////////////////////////////////////////////////////////////////////
// reg_index_fp_desc_dyn_row_dep_sm90::decode()
cuphyStatus_t reg_index_fp_desc_dyn_row_dep_sm90::decode(ldpc::decoder&                     dec,
                                                         LDPC_output_t&                     tDst,
                                                         const_tensor_pair&                 tLLR,
                                                         const cuphyLDPCDecodeConfigDesc_t& config,
                                                         cudaStream_t                       strm)
{
    DEBUG_PRINTF("ldpc2::reg_index_fp_desc_dyn_row_dep_sm90_decode()\n");
    //------------------------------------------------------------------
    ...
    if(llrType == CUPHY_R_16F)
    {
        ...
        case 1:
            {
                const int         BG     = 1;
                CUfunction        f      = sm90_dyn_desc_row_dep_BG1_kernel_;
        ...
        case 2:
            {
                const int         BG     = 2;
                CUfunction        f      = sm90_dyn_desc_row_dep_BG2_kernel_;
...
////////////////////////////////////////////////////////////////////////
// reg_index_fp_desc_dyn_row_dep_sm90::decode_tb()
cuphyStatus_t reg_index_fp_desc_dyn_row_dep_sm90::decode_tb(ldpc::decoder&               dec,
                                                            const cuphyLDPCDecodeDesc_t& decodeDesc,
                                                            cudaStream_t                 strm)
{
    DEBUG_PRINTF("ldpc2::reg_index_fp_desc_dyn_row_dep_sm90::decode_tb()\n");
    //------------------------------------------------------------------
    ...
    if(decodeDesc.config.llr_type == CUPHY_R_16F)
    {
        ...
        case 1:
            {
                const int         BG     = 1;
                CUfunction        f      = sm90_dyn_desc_row_dep_BG1_tb_kernel_;
        ...
        case 2:
            {
                const int         BG     = 2;
                CUfunction        f      = sm90_dyn_desc_row_dep_BG2_tb_kernel_;
...
////////////////////////////////////////////////////////////////////////
// reg_index_fp_desc_dyn_row_dep_sm90::get_workspace_size()
std::pair<bool, size_t> reg_index_fp_desc_dyn_row_dep_sm90::get_workspace_size(const ldpc::decoder&               dec,
...
////////////////////////////////////////////////////////////////////////
// reg_index_fp_desc_dyn_row_dep_sm90::reg_index_fp_desc_dyn_row_dep_sm90()
reg_index_fp_desc_dyn_row_dep_sm90::reg_index_fp_desc_dyn_row_dep_sm90(ldpc::decoder& dec)
{
    assert(dec.compute_cap() >= ((8ULL << 32) + 6));
    //------------------------------------------------------------------
    // Load SM90 binaries for use with the CUDA driver API.
    //
    // SM9.0 support requires CUDA 11.8 Only attempt to load the
    // .cubin if the current device is SM90 or greater...
    ...
    if(cudaRuntimeVersion >= 11080)
    {
        sm90_dyn_desc_row_dep_module_.load(ldpc2_reg_index_fp_desc_dyn_row_dep_sm90_internal);
        sm90_dyn_desc_row_dep_BG1_kernel_    = sm90_dyn_desc_row_dep_module_.get_function(sm90_dyn_desc_row_dep_BG1_kernel_name/*,    std::nothrow_t()*/);
        sm90_dyn_desc_row_dep_BG2_kernel_    = sm90_dyn_desc_row_dep_module_.get_function(sm90_dyn_desc_row_dep_BG2_kernel_name/*,    std::nothrow_t()*/);
        sm90_dyn_desc_row_dep_BG1_tb_kernel_ = sm90_dyn_desc_row_dep_module_.get_function(sm90_dyn_desc_row_dep_BG1_tb_kernel_name/*, std::nothrow_t()*/);
        sm90_dyn_desc_row_dep_BG2_tb_kernel_ = sm90_dyn_desc_row_dep_module_.get_function(sm90_dyn_desc_row_dep_BG2_tb_kernel_name/*, std::nothrow_t()*/);
        //printf("sm90_dyn_desc_row_dep_BG1_kernel_    = %p\n", sm90_dyn_desc_row_dep_BG1_kernel_);
        //printf("sm90_dyn_desc_row_dep_BG2_kernel_    = %p\n", sm90_dyn_desc_row_dep_BG2_kernel_);
        //printf("sm90_dyn_desc_row_dep_BG1_tb_kernel_ = %p\n", sm90_dyn_desc_row_dep_BG1_tb_kernel_);
        //printf("sm90_dyn_desc_row_dep_BG2_tb_kernel_ = %p\n", sm90_dyn_desc_row_dep_BG2_tb_kernel_);
        ...
        {
            func_attr_t(sm90_dyn_desc_row_dep_BG1_kernel_,    MAX_BG1_SHMEM_SIZE),
            func_attr_t(sm90_dyn_desc_row_dep_BG2_kernel_,    MAX_BG2_SHMEM_SIZE),
            func_attr_t(sm90_dyn_desc_row_dep_BG1_tb_kernel_, MAX_BG1_SHMEM_SIZE),
            func_attr_t(sm90_dyn_desc_row_dep_BG2_tb_kernel_, MAX_BG2_SHMEM_SIZE)
        };
...
////////////////////////////////////////////////////////////////////////
// reg_index_fp_desc_dyn_row_dep_sm90::get_launch_config()
cuphyStatus_t reg_index_fp_desc_dyn_row_dep_sm90::get_launch_config(const ldpc::decoder&           dec,
