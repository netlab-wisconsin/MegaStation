...
#if !defined(LDPC2_REG_INDEX_FP_DP_DESC_DYN_ROW_DEP_HPP_INCLUDED_)
#define LDPC2_REG_INDEX_FP_DP_DESC_DYN_ROW_DEP_HPP_INCLUDED_
...
////////////////////////////////////////////////////////////////////////
// reg_index_fp_dp_desc_dyn_row_dep
class reg_index_fp_dp_desc_dyn_row_dep : public ldpc::decode_algo
{
public:
    //------------------------------------------------------------------
    // Constructor
    reg_index_fp_dp_desc_dyn_row_dep(ldpc::decoder& desc);
    //------------------------------------------------------------------
    // decode()
...
#endif // !defined(LDPC2_REG_INDEX_FP_DP_DESC_DYN_ROW_DEP_HPP_INCLUDED_)
